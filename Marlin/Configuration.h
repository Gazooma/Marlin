...
#define STRING_CONFIG_H_AUTHOR "Tronxy X6A SKR v1.4" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tronxy X6A"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 188.97
  #define DEFAULT_bedKi 34.26
  #define DEFAULT_bedKd 694.82
...
#define NOZZLE_TO_PROBE_OFFSET { -41, 0, -0.10 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   1.8  // G26 Q (retraction) used by default between mesh test elements.
  #endif
